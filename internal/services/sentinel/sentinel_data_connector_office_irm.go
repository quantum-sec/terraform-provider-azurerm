...
func resourceSentinelDataConnectorOfficeIRM() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		Create: resourceSentinelDataConnectorOfficeIRMCreateUpdate,
		Read:   resourceSentinelDataConnectorOfficeIRMRead,
		Update: resourceSentinelDataConnectorOfficeIRMCreateUpdate,
...
func resourceSentinelDataConnectorOfficeIRMCreateUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
